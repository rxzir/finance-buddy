...
final class ChatViewModel {
    ...
    @ObservationIgnored private weak var store: HeadroomStore?

    init(store: HeadroomStore? = nil, service: (any AskServing)? = nil) {
        self.store = store
...
struct AskView: View {
    ...
    init(store: HeadroomStore, isActive: Bool = true,
