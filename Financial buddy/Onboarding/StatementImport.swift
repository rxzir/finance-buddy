    ...
    private var pickerContent: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                Text("Export monthly PDFs from your bank app, then choose up to 12 files. Finance Buddy reads them on-device and detects your recurring payments — nothing is uploaded.")
                    .font(.fbBody(14))
                    .foregroundStyle(Color.fbSoftText)
...
#Preview("Import — picker") {
    StatementImportFlow(store: FinanceBuddyStore(finances: .empty), onDone: {})
